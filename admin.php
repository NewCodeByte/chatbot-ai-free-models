...
<body>
    ...
    <div id="sounds-message-area" class="feedback-area"></div> 
        ...
        <div id="license" class="tab-content" style="display: none;">
            ...
            <p><?php echo escape(__('2. Il link nel footer può essere rimosso solo dopo una donazione una tantum di almeno $10 USD (')); ?><a href="https://buymeacoffee.com/codebytewp" target="_blank" rel="noopener noreferrer"><b>https://buymeacoffee.com/codebytewp</b></a><?php echo escape(__('). La rimozione non autorizzata del link nel footer costituisce una violazione di questa licenza.')); ?></p>
